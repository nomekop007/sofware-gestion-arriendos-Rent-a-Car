...
<head>
    ...
    <script src="<?php echo base_route() ?>assets/js/utils/utilidades.js?v=<?php echo version(); ?>"></script>
    ...
    <script src="<?php echo base_route() ?>assets/js/utils/datatables.min.js"></script>
    ...
    <script src="<?php echo base_route() ?>assets/js/utils/owl.carousel.min.js"></script>

    <!-- importacion input datatime -->
    <script src="<?php echo base_route() ?>assets/js/utils/jquery.datetimepicker.full.min.js"></script>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_route() ?>assets/css/fullCalendar.min.css">

    <script src="<?php echo base_route() ?>assets/js/utils/fullCalendar.min.js"></script>

    <script src="<?php echo base_route() ?>assets/js/utils/idiomaCalendario.js"></script>
