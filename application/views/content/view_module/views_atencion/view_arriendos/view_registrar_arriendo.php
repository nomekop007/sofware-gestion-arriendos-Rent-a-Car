        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                <div class="list-group" id="list-tab" role="tablist">
                    ...
                    <a class="list-group-item list-group-item-action list-group-item-dark" id="list-conductor-list" data-toggle="list" href="#list-conductor" role="tab" aria-controls="conductor"> Datos
                        conductor</a>
                        ...
                        <div class="card card-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-xl-6">
                                    ...
                                    <input type="text" class="form-control " readonly name="inputFechaEntrega" id="inputFechaEntrega" required />
                                </div>

                                <div class="form-group col-xl-6">
                                    <label for="inputFechaRecepcion">Fecha de Recepcion</label>
                                    <input type="text" class="form-control" readonly name="inputFechaRecepcion" id="inputFechaRecepcion" required />
                                </div>
                        ...
                        <div class="card card-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-xl-6">
                                    ...
                                    <input onblur="mayus(this);" maxLength="50" type="text" class="form-control" id="inputDomicilioContacto" name="inputDomicilioContacto" required>
                                </div>
                                <div class="form-group col-xl-6">
                                    <label for="inputNumeroCasaContacto">Numero casa </label>
                                    <input oninput="this.value = soloNumeros(this)" maxLength="10" type="number" class="form-control" id="inputNumeroCasaContacto" name="inputNumeroCasaContacto" required>
                                </div>
                                <div class="form-group col-xl-6">
                                    <label for="inputCiudadContacto">Ciudad </label>
                                    <input onblur="mayus(this);" maxLength="50" type="text" class="form-control" id="inputCiudadContacto" name="inputCiudadContacto" required>
                                </div>
                                <div class="form-group col-xl-6">
                        ...
                        <div class="card card-body">
                            ...
                            <div class="form-row">
                                <div class="custom-control custom-radio custom-control-inline ">
                                    <input onclick="cantidadConductores(this.value);" type="radio" value="1" id="radioConductor1" name="customRadio5" class="custom-control-input" checked>
                                    <label class="custom-control-label" for="radioConductor1">un conductor</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline ">
                                    <input onclick="cantidadConductores(this.value);" type="radio" value="2" id="radioConductor2" name="customRadio5" class="custom-control-input">
                                    <label class="custom-control-label" for="radioConductor2">dos conductores</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline ">
                                    <input onclick="cantidadConductores(this.value);" type="radio" value="3" id="radioConducto3" name="customRadio5" class="custom-control-input">
                            ...
                            <div class="card">
                                <div class="form-row card-body">
                                    ...
                                    <div class="form-group col-xl-6">
                                        ...
                                        <input type="text" class="form-control input_data" readonly name="inputVCTOConductor" id="inputVCTOConductor" required />
                                    </div>
                                    <div class="form-group col-xl-6">
                            ...
                            <div class="card" id="card_conductor_2">
                                ...
                                <div class="form-row card-body">
                                    <div class="form-group  col-xl-6">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" maxLength="12" type="text" id="inputRutConductor2" name="inputRutConductor2" required>
                                            <div class="input-group-append">
                                                <button class="btn btn-outline-secondary" type="button" id="btn_buscarConductor2">
                                                    <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true" id="spinner_conductor2"></span>
                                                    Buscar</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group col-xl-6">
                                        ...
                                        <select name="inputNacionalidadConductor2" id="inputNacionalidadConductor2" class="form-control">
                                            <option value="CHILENO/A" selected>Chileno/a</option>
                                            <option value="EXTRANJERO/A">Extranjero/a</option>
                                        </select>
                                    </div>
                                    <div class="form-group col-xl-6">
                                        ...
                                        <input onblur="mayus(this);" maxLength="50" type="text" class="form-control" id="inputNombreConductor2" name="inputNombreConductor2" required>
                                    </div>
                                    <div class="form-group col-xl-6">
                                        <label for="inputVCTOConductor2">VCTO</label>
                                        <input type="text" class="form-control input_data" readonly name="inputVCTOConductor2" id="inputVCTOConductor2" required />
                                    </div>
                                    <div class="form-group col-xl-6">
                                        <label for="inputDireccionConductor2">Direccion</label>
                                        <input onblur="mayus(this);" maxLength="50" type="text" class="form-control" id="inputDireccionConductor2" name="inputDireccionConductor2" required>
                                    </div>
                                    <div class="form-group col-xl-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input oninput="this.value = soloNumeros(this)" maxLength="8" type="number" class="form-control" id="inputTelefonoConductor2" name="inputTelefonoConductor2" required>
                                        </div>
                                    </div>

                                    <div class="form-group col-xl-6">
                                        <label for="inputClaseConductor2">Clase</label>
                                        <select name="inputClaseConductor2" id="inputClaseConductor2" class="form-control">
                                            <option value="Clase B" selected>Clase B</option>
                                            <option value="Clase C">Clase C</option>
                                            <option value="Clase D">Clase D</option>
                                            <option value="Clase E">Clase E</option>
                                    ...
                                    <div class="form-group col-xl-6">
                                        ...
                                        <input oninput="this.value = soloNumeros(this)" maxLength="11" type="number" class="form-control" id="inputNumeroConductor2" name="inputNumeroConductor2" required>
                                    </div>
                                    <div class="form-group col-xl-6">
                                        <label for="inputMunicipalidadConductor2">Municipalidad</label>
                                        <input onblur="mayus(this);" maxLength="30" type="text" class="form-control" id="inputMunicipalidadConductor2" name="inputMunicipalidadConductor2" required>
                                    </div>
                                </div>
                            </div>
                            <br>
                            ...
                            <div class="card" id="card_conductor_3">
                                ...
                                <div class="form-row card-body">
                                    <div class="form-group  col-xl-6">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" maxLength="12" type="text" id="inputRutConductor3" name="inputRutConductor3" required>
                                            <div class="input-group-append">
                                                <button class="btn btn-outline-secondary" type="button" id="btn_buscarConductor3">
                                                    <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true" id="spinner_conductor3"></span>
                                                    Buscar</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group col-xl-6">
                                        ...
                                        <select name="inputNacionalidadConductor3" id="inputNacionalidadConductor3" class="form-control">
                                            <option value="CHILENO/A" selected>Chileno/a</option>
                                            <option value="EXTRANJERO/A">Extranjero/a</option>
                                        </select>
                                    </div>
                                    <div class="form-group col-xl-6">
                                        ...
                                        <input onblur="mayus(this);" maxLength="50" type="text" class="form-control" id="inputNombreConductor3" name="inputNombreConductor3" required>
                                    </div>
                                    <div class="form-group col-xl-6">
                                        <label for="inputVCTOConductor3">VCTO</label>
                                        <input type="text" class="form-control input_data" readonly name="inputVCTOConductor3" id="inputVCTOConductor3" required />
                                    </div>
                                    <div class="form-group col-xl-6">
                                        <label for="inputDireccionConductor3">Direccion</label>
                                        <input onblur="mayus(this);" maxLength="50" type="text" class="form-control" id="inputDireccionConductor3" name="inputDireccionConductor3" required>
                                    </div>
                                    <div class="form-group col-xl-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input oninput="this.value = soloNumeros(this)" maxLength="8" type="number" class="form-control" id="inputTelefonoConductor3" name="inputTelefonoConductor3" required>
                                        </div>
                                    </div>

                                    <div class="form-group col-xl-6">
                                        <label for="inputClaseConductor3">Clase</label>
                                        <select name="inputClaseConductor3" id="inputClaseConductor3" class="form-control">
                                            <option value="Clase B" selected>Clase B</option>
                                            <option value="Clase C">Clase C</option>
                                            <option value="Clase D">Clase D</option>
                                            <option value="Clase E">Clase E</option>
                                    ...
                                    <div class="form-group col-xl-6">
                                        ...
                                        <input oninput="this.value = soloNumeros(this)" maxLength="11" type="number" class="form-control" id="inputNumeroConductor3" name="inputNumeroConductor3" required>
                                    </div>
                                    <div class="form-group col-xl-6">
                                        <label for="inputMunicipalidadConductor3">Municipalidad</label>
                                        <input onblur="mayus(this);" maxLength="30" type="text" class="form-control" id="inputMunicipalidadConductor3" name="inputMunicipalidadConductor3" required>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card card-body">
                            ...
                            <div class="form-row">
                                <div class="form-group col-xl-4">
                                    <label for="inputEntrada">kilometraje Actual</label>
                                    <input oninput="this.value = soloNumeros(this) ; calcularMantencionVehiculo()" value=0 maxLength="7" type="number" class="form-control" id="inputEntrada" name="inputEntrada" required>
                                </div>
                                <div class="fomr-group col-xl-4">
                                    <label for="Tmantencion_vehiculo">kilometros ultima Mantencion</label>
                                    <input type="number" value=0 maxLength="7" class="form-control" id="Tmantencion_vehiculo" name="Tmantencion_vehiculo" oninput="this.value = soloNumeros(this) ; calcularMantencionVehiculo()" required>
                                </div>
                                <div class="form-group col-xl-4">
                                    <label for="inputMantencion">kilometros siguiente mantencion (aprox)</label>
