...
<div class="tab-pane fade" id="nav-arriendos" role="tabpanel" aria-labelledby="nav-arriendos-tab">
    <br><br>
    <div class="scroll">
        <table id="tablaArriendosProceso" class="table table-striped table-bordered " style="width:100%">
    ...
    <div class="text-center" id="spinner_tablaArriendosProceso">
...
<!-- Tab con la tabla de los arriendos activos -->
<div class="tab-pane fade" id="nav-total-arriendos" role="tabpanel" aria-labelledby="nav-totalArriendos-tab">
    <br><br>
    <div class="scroll">
