						...
						<div class="card card-body">
							...
							<div class="form-row">
								...
								<div class="form-group col-xl-6">
									...
									<input type="text" class="form-control " name="inputFechaEntrega" id="inputFechaEntrega" required />
								</div>

								<div class="form-group col-xl-6">
									<label for="inputFechaRecepcion">Fecha de Recepcion</label>
									<input type="text" class="form-control" name="inputFechaRecepcion" id="inputFechaRecepcion" required />
								</div>
						...
						<div class="card card-body">
							...
							<div class="form-row" id="form_cliente">
								...
								<div class="form-group col-xl-6">
									...
									<input type="text" class="form-control input_data" name="inputFechaNacimiento" id="inputFechaNacimiento" required />
								</div>
							...
							<div class="card">
								<div class="form-row card-body">
									...
									<div class="form-group col-xl-6">
										...
										<input type="text" class="form-control input_data" name="inputVCTOConductor" id="inputVCTOConductor" required />
									</div>
									<div class="form-group col-xl-6">
							...
							<div class="card" id="card_conductor_2">
								...
								<div class="form-row card-body">
									...
									<div class="form-group col-xl-6">
										...
										<input type="text" class="form-control input_data" name="inputVCTOConductor2" id="inputVCTOConductor2" required />
									</div>
									<div class="form-group col-xl-6">
							...
							<div class="card" id="card_conductor_3">
								...
								<div class="form-row card-body">
									...
									<div class="form-group col-xl-6">
										...
										<input type="text" class="form-control input_data" name="inputVCTOConductor3" id="inputVCTOConductor3" required />
									</div>
									<div class="form-group col-xl-6">
						...
						<div class="card card-body">
							...
							<div class="form-row">
								<div class="form-group col-xl-6">
									...
									<input oninput="this.value = soloNumeros(this) ; calcularMantencionVehiculo(this.value)" value=0 maxLength="7" type="number" class="form-control" id="inputEntrada" name="inputEntrada" required>
								</div>
								<div class="form-group col-xl-6">
