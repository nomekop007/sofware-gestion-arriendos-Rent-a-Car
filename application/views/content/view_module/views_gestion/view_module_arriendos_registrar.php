                        ...
                        <div class="card card-body">
                            ...
                            <div class="form-row">
                                <div class="form-group col-xl-4">
                                    ...
                                    <input oninput="this.value = soloNumeros(this) ; calcularMantencionVehiculo()"
                                ...
                                <div class="fomr-group col-xl-4">
                                    ...
                                    <input type="number" value=0 maxLength="7" class="form-control"
                                        id="Tmantencion_vehiculo" name="Tmantencion_vehiculo"
                                        oninput="this.value = soloNumeros(this) ; calcularMantencionVehiculo()"
                                        required>
                                </div>
                                <div class="form-group col-xl-4">
