...
<div class="tab-pane fade show active" id="nav-registrar" role="tabpanel" aria-labelledby="nav-registrar-tab">
    ...
    <form class="needs-validation" novalidate id="form_registrar_arriendo">
        <p class="form-row">
            <a id="btn-arriendo" class="btn btn-dark btn-sm" data-toggle="collapse" href="#collapseArriendo" role="button" aria-expanded="false" aria-controls="collapseArriendo">
                Datos arriendo
            </a>
            <a id="btn-cliente" class="btn btn-dark btn-sm" data-toggle="collapse" href="#collapseCliente" role="button" aria-expanded="false" aria-controls="collapseCliente">
                Datos cliente
            </a>
            <a id="btn-contacto" class="btn btn-dark btn-sm" data-toggle="collapse" href="#collapseContacto" role="button" aria-expanded="false" aria-controls="collapseContacto">
                Datos contacto
            </a>
            <a id="btn-conductor" class="btn btn-dark btn-sm" data-toggle="collapse" href="#collapseConductor" role="button" aria-expanded="false" aria-controls="collapseConductor">
                Datos conductor
            </a>
            <a id="btn-garantia" class="btn btn-dark btn-sm" data-toggle="collapse" href="#collapseGarantia" role="button" aria-expanded="false" aria-controls="collapseGarantia">
                Garantia requerida
            </a>
            <a id="btn-vehiculo" class="btn btn-dark btn-sm" data-toggle="collapse" href="#collapseVehiculos" role="button" aria-expanded="false" aria-controls="collapseVehiculos">
            ...
            <div class="card card-body">
                ...
                <div class="form-row" id="form_cliente">
                    <div class="form-group col-md-3">
                        ...
                        <div class="input-group">
                            <input maxLength="12" type="text" placeholder="Ej. 11.111.111-1" class="form-control" id="inputRutCliente" name="inputRutCliente" required>
                ...
                <div class="form-row" id="form_empresa">
                    <div class="form-group col-md-4">
                        ...
                        <div class="input-group">
                            <input maxLength="12" type="text" placeholder="Ej. 11.111.111-1" type="text" class="form-control" id="inputRutEmpresa" name="inputRutEmpresa" required>
                            <div class="input-group-append">
            ...
            <div class="card card-body">
                ...
                <div class="form-row">
                    <div class="form-group  col-md-4">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" maxLength="12" type="text" placeholder="Ej. 11.111.111-1" id="inputRutConductor" name="inputRutConductor" required>
                            <div class="input-group-append">
            ...
            <div class="card card-body">
                ...
                <div class="form-row">
                    ...
                    <div class="input-group col-md-7" required>
                        <select disabled class="custom-select form-control" id="select_vehiculos" name="select_vehiculos" style="width: 100%;">
                        </select>
                    </div>
                </div>
                <br>
                ...
                <div class="form-row">
                    <div class="form-group col-md-2">
                        ...
                        <input oninput="this.value = soloNumeros(this)" value=0 maxLength="11" type="number" class="form-control" id="inputEntrada" name="inputEntrada" required>
                    </div>
                    <div class="form-group col-md-2">
                        <label for="inputSalida">Salida</label>
                        <input oninput="this.value = soloNumeros(this)" maxLength="11" type="number" class="form-control" id="inputSalida" name="inputSalida" disabled>
                    </div>
                    <div class="form-group col-md-3">
                        <label for="inputMantencion">kilometros para siguiente mantencion</label>
                        <input oninput="this.value = soloNumeros(this)" value=0 maxLength="11" type="number" class="form-control" id="inputMantencion" name="inputMantencion" required>
                    </div>
                </div>
                <br>
                <h4>Accesorios</h4>
                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="inputOtros" id="inputOtros" onblur="mayus(this);" maxLength="20" class="form-control" aria-label="Sizing example input" aria-describedby="inputOtros">
                        </div>
                    </div>
                </div>
            </div>
