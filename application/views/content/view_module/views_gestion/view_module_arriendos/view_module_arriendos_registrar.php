                    ...
                    <div class="form-row" id="form_cliente">
                        <div class="form-group col-md-3">
                            ...
                            <div class="input-group">
                                <input maxLength="9" onblur=" value ? this.value=formateaRut(this.value) : null"
                                    type="text" class="form-control" id="inputRutCliente" name="inputRutCliente"
                                    required>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input onblur="mayus(this);" value="1990-01-01" maxLength="30" type="date"
                                class="form-control" id="inputFechaNacimiento" name="inputFechaNacimiento" required>
                        </div>
                        <div class="form-group col-md-2">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="input-group">
                                <input maxLength="10" onblur=" value ? this.value=formateaRut(this.value) : null"
                                    type="text" class="form-control" id="inputRutEmpresa" name="inputRutEmpresa"
                                    required>
                                <div class="input-group-append">
                        ...
                        <div class="form-group col-md-12" id="card-tarjeta">
                            ...
                            <div class="input-group">
                                <input oninput="this.value = soloNumeros(this)" style="width: 50%;" type="number"
                                    ...
                                    maxLength="25" placeholder="Nº Tarjeta de credito" required>
