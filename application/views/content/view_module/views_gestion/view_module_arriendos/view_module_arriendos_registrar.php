                 ...
                 <div class="form-row">
                     ...
                     <div class="form-group col-md-4">
                         ...
                         <select id="inputTipo" class="form-control">
                             ...
                             <option value="empresa remplazo copago">Arriendo empresa remplazo
                                 copago</option>
         ...
         <div class="collapse" id="collapseCliente">
             <div class="card card-body">
                 ...
                 <div class="form-row">
                     ...
                     <div class="form-group col-md-4">
                         <label for="inputDireccionEmpresa">Direccion Comercial o Extranjera </label>
                         <input oninput="mayus(this);" maxLength="30" type="text" class="form-control"
                             id="inputDireccionEmpresa" required>
                     </div>
                     <div class="form-group col-md-4">
                         <label for="inputCiudadEmpresa">Ciudad Comercial</label>
                         <input oninput="mayus(this);" maxLength="30" type="text" class="form-control"
