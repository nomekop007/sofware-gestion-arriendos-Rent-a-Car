				...
				<form class="needs-validation" id="formExtenderArriendo" novalidate>
					...
					<div class="form-row">
						<div class="form-group col-md-5">
							...
							<input disabled class="form-control" type="text" name="inputFechaRecepcion_extenderPlazo" id="inputFechaRecepcion_extenderPlazo" required />
						</div>
						<div class="form-group col-md-5">
							<label for="inputFechaExtender_extenderPlazo">Fecha a extender</label>
							<input type="text" class="form-control" name="inputFechaExtender_extenderPlazo" id="inputFechaExtender_extenderPlazo" required />
						</div>
				...
				<div class="row">
					...
					<div class="form-group col-lg-12 text-center">
						...
						<div class="form-group form-check">
							<label class="form-check-label" for="dibujar_canvas_recepcion"><input type="checkbox" class="form-check-input" id="dibujar_canvas_recepcion" name="dibujar_canvas_recepcion">dibujar en pizarra</label>
						</div>
					</div>
		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<button type="button" id="registrar_danio_vehiculo" class="btn btn-warning">
					<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true" id="spinner_btn_registrar_danio"></span>
