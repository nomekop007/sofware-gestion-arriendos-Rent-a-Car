<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                ...
                <nav >
                    <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                        <a
                            ...
                            aria-selected="true">Registrar Traslado</a>
                        <a
                            ...
                            aria-selected="false">Recepcionar Vehiculo Traslado</a>
                        <a
                            class="nav-item nav-link"
                            id="nav-contact-tab"
                            data-toggle="tab"
                            ...
                            aria-selected="false">Todos los Traslados</a>
                    </div>
                </nav>
                            ...
                            <div id="DivTablaVehiculosDispSucursal">
                                ...
                                <div
                                    ...
                                    <div id="DIV-TablaRecepcionTraslado">
                                        ...
                                        <div
                                        class="modal fade bd-example-modal-lg "
                                        id="ModalTrasladoRecepcion"
                                        tabindex="-1"
                                        role="dialog"
                                        aria-labelledby="ModalTrasladoRecepcionLabel"
                                        aria-hidden="true">
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                            ...
                                            <div id="Div-AllTraslados">
                                                ...
                                                <div class="modal fade" id="ModalImagenesOrigenAll" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLabel">Imagenes de susursal destino</h5>
                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                <span aria-hidden="true">&times;</span>
                                                                </button>
                                                            </div>
    ...
    <script
        src="<?php echo base_route() ?>assets/js/js_gestion/js_traslado/js_module_traslado.js?v=<?php echo version(); ?>"></script>

    <script
        src="<?php echo base_route() ?>assets/js/js_gestion/js_traslado/js_module_traslado_recepcion.js?v=<?php echo version(); ?>"></script>

</script>

    <script
        src="<?php echo base_route() ?>assets/js/js_gestion/js_traslado/js_module_AllTraslado.js?v=<?php echo version(); ?>"></script>
