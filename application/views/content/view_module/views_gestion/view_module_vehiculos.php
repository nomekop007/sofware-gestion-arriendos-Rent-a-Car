                ...
                <form class="needs-validation" novalidate id="form_registrar_vehiculo">
                    <div class="form-row">
                        ...
                        <div class="form-group col-lg-2">
                            ...
                            <input onblur="mayus(this);" maxLength="50" type="text" class="form-control" id="inputChasis" name="inputChasis" required>
                        </div>

                        <div class="form-group col-lg-2">
                            <label for="inputColor">Color</label>
                            <input onblur="mayus(this);" maxLength="15" type="text" class="form-control" id="inputColor" name="inputColor" required>
                        </div>
                        <div class="form-group col-lg-3">
                            <label for="inputNumeroMotor">Nº Motor</label>
                            <input oninput="this.value = soloNumeros(this)" type="number" maxLength="11" class="form-control" id="inputNumeroMotor" name="inputNumeroMotor" required>
                        </div>
                        <div class="form-group col-lg-3">
                        ...
                        <div class="form-group col-lg-3">
                            ...
                            <input type="date" class="form-control" id="inputFechaCompra" name="inputFechaCompra" required>
                        </div>
                                ...
                                <div class="col-md-8">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-lg-4">
                                            ...
                                            <input onblur="mayus(this);" maxLength="15" type="text" class="form-control" id="inputEditarColor" name="inputEditarColor" required>
                                        </div>
                                        <div class="form-group col-lg-4">
                                            <label for="inputEditarNumeroMotor">Nº Motor del Vehiculo</label>
                                            <input oninput="this.value = soloNumeros(this)" type="number" maxLength="11" class="form-control" id="inputEditarNumeroMotor" name="inputEditarNumeroMotor" required>
                                        </div>
                                        <div class="form-group col-lg-4">
                                        ...
                                        <div class="form-group col-lg-6">
                                            <label for="inputEditarkilomentrosMantencion">kilometros de mantencion</label>
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            <input type="date" class="form-control" id="inputEditarFechaCompra" name="inputEditarFechaCompra" required>
                                        </div>
